...
<div class="title">
		...
		<span class=botton_margin1><a href="<?php echo Yii::app()->request->baseurl?>/index.php/trainMaster/create"><button class="btn btn-success" rel="tooltip" data-placement="right">Create</button></a><span class="botton_mergin3"></span><a href="<?php echo Yii::app()->request->baseurl?>/index.php/trainMaster/index"><button class="btn btn-success" rel="tooltip" data-placement="right">List Train Master</button></a><span class="botton_mergin3"></span><a href="<?php echo Yii::app()->request->baseurl?>/index.php/flightMaster/index"><button class="btn btn-success" rel="tooltip" data-placement="right">List Flight Master</button></a></span></span></span>
            </h3>
          </div>
<?php 
$this->widget('zii.widgets.grid.CGridView', array
	...
	'columns' => array
		...
		array
			...
			'name' => 'choose_branch',
			'htmlOptions' => array("style" => "text-align:center"),
			'value'=>'FlightMaster::model()->getBranchname($data->choose_branch)',
		),
