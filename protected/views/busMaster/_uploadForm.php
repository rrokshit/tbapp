...
Yii::app()->clientScript->registerScript(
   'validatePlayerForm',
   '$("#bus-master-upload-form").submit(function(e){
		var validate=true,
                ...
                <h3>
					...
					<span>Bus Master
						...
						<span class="botton_margin1">
							<a href="<?php echo Yii::app()->createUrl("BusMaster/admin"); ?>" class="btn btn-success">Bus</a>
						</span>        
						</span>
				</h3>
            </div>
		...
		<div class="form-horizontal span12">
			<div class="form-row control-group row-fluid fluid">
				<div>
					...
					<div style="overflow:auto;"><img src="images/excel_snapshots/bus_master.PNG"/></div>
				</div>
			</div>
		</div>
	</div>
