...
<div class="box gradient">
    ...
    <div class="content">
        ...
        <?php echo $form->textField($model_sightseen, 'arrival_id', array('value' => $_GET['arrival_id'], 'readonly' => 'readonly', 'style' => "display:none")); ?>
        ...
        <div class="form-row control-group row-fluid">
            ...
            <div class="controls span7">
                    <?php
                    $oo = count($chkSightSeen);
                    if ($oo < 1)
                        $arrDate = date("Y-m-d", strtotime($pnrDetails->arrival_date));
                    else
                        $arrDate = date("Y-m-d", strtotime("$pnrDetails->arrival_date +$oo day"));
					?>
        ...
        <div class="form-row control-group row-fluid">
            ...
            <div class="controls span7">
                <?php
                $shopList = explode(',', AgencyMaster::model()->findByPk(Entries::model()->find("pnr_no='" . $pnrDetails->pnr_no . "'")->agency)->choose_approved_shop);
                $sel = array();
        ...
        <div class="form-row control-group row-fluid">
            ...
            <div class="controls span7">
                <?php
                echo $form->dropDownList($model_serviceUpdate, 'serviceName', CHtml::listData(ServiceMaster::model()->findAll(), 'id', 'service_name'), array('class' => 'chosen-select', 'multiple' => 'multiple'));
                ?>
            </div>
        </div>
        ...
        <div class="form-row control-group row-fluid">
            ...
            <div class="controls span7">
                <?php echo $form->listBox($model_serviceUpdate, 'entranceBy', array('TB' => 'TB', 'DIR' => 'DIR', 'Escort' => 'Escort', 'Not Clear' => 'Not Clear', 'Indian TB' => 'Indian TB'), array('class' => 'chosen-select',)); ?>
        ...
        <div class="form-row control-group row-fluid">
            ...
            <div class="controls span7">
                <?php
                echo $form->textField($model_sightseen, 'noOfGuide', array('class' => 'row-fluid', 'value' => 0));
                ?>
            </div>
        </div>
        ...
        <table class="row-fluid" id="guideDetailsHeader" style="display: none">
            <tr>
                <th>Language</th>
                <th>Guide</th>
                <th>Work Type</th>
        ...
        <span id="guideDetailsAppend"></span>

        <!-- end guide details -->

        <?php if ($pnrDetails->vehicle_required == 'No') { ?>
            <div class="form-row control-group row-fluid">
        ...
        <div class="form-row control-group row-fluid">
            ...
            <div class="controls span7">
                ...
                if(Yii::app()->controller->action->id=='create'){
                    $noOfVehicle = $pnrDetails->totalVeh;
                }
                ?>
                <?php
                $lv = array();
                ...
                ?>
                <?php echo $form->textField($model_sightseen, 'no_of_vehicle', array('value' => $noOfVehicle)); ?>  
        ...
        <span id="arrivalVehicleDoc">
            <?php
            //if arrival was booked vehicle 
            if(Yii::app()->controller->action->id=='create' && $pnrDetails->totalVeh>0){
                $getArrivalVehicle = ArrivalVehicle::model()->findAll("type='Arrival' and particularPk='".$pnrDetails->id."' group by vehicleCategory, acOrNot");
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-row control-group row-fluid">
                                    <div class="controls span7">
                                        <?php
                                        echo $form->textField($model_arrivalVehicle, 'noOfVehicle[]', array('value' => sizeof(ArrivalVehicle::model()->findAll("type='Arrival' and particularPk='".$pnrDetails->id."' and vehicleCategory=$arrVD->vehicleCategory"))));
                                        ?> 
                                    </div>
                                </div>
                            </td>
        ...
        //if (count($chkSightSeen) < 1) {
            ...
            <div class="form-row control-group row-fluid" id="S_time">
                ...
                <div class="controls span7">
                    ...
                    echo $form->dropDownList($model_serviceUpdate, 'serviceTime[]', $hh, array('empty' => 'HH', 'style' => 'width:66px'));
                    echo $form->dropDownList($model_serviceUpdate, 'serviceTime[]', $mm, array('empty' => 'MM', 'style' => 'width:66px'));
                    ?>
                </div>
            </div>
        <?php //} ?>
