...
Yii::app()->clientScript->registerScript(
   'validatePlayerForm',
   '$("#arrival-upload-form").submit(function(e){
		var validate=true,
    ...
    <div class="box gradient">
        <div>
			<div class="title">
                <h3>
					<i class="icon-book"></i>
					<span>Sightseeing Services Vehicle Upload
						<span class="botton_mergin3"></span>
						<span class="botton_margin1">
							<a href="<?php echo Yii::app()->createUrl("Sightseen/admin"); ?>" class="btn btn-success">Sightseeings</a>
						</span>        
						</span>
				</h3>
            </div>
	...
	<div class="form-row control-group row-fluid">
		<div class="form-horizontal span6">
			<div class="form-row control-group row-fluid fluid">
				<label>Sightseeing Services Vehicle File</label>
			...
			<div class="form-row control-group row-fluid fluid">
				<?php if(isset($this->importStatus)){?>
					<table style="width:100%;">
						<tr>
							<th>Upload Sightseeing Services Vehicle Status</th>
						</tr>	
		...
		<div class="form-horizontal span12">
			<div class="form-row control-group row-fluid fluid">
				<div>
					...
					<div style="overflow:auto;"><img src="images/excel_snapshots/siteseen_vehicle.PNG"/></div>
				</div>
			</div>
		</div>
	</div>
