...
Yii::app()->clientScript->registerScript(
   'validatePlayerForm',
   '$("#approved-shops-upload-form").submit(function(e){
		var validate=true,
                ...
                <h3>
					...
					<span>Approved Shops Master
						...
						<span class="botton_margin1">
							<a href="<?php echo Yii::app()->createUrl("ApprovedShops/admin"); ?>" class="btn btn-success">Shops</a>
						</span>        
						</span>
				</h3>
            </div>
	...
	<div class="form-row control-group row-fluid">
		<div class="form-horizontal span6">
			<div class="form-row control-group row-fluid fluid">
				<label>Approved Shops Master File</label>
			...
			<div class="form-row control-group row-fluid fluid">
				<?php if(isset($this->importStatus)){?>
					<table style="width:100%;">
						<tr>
							<th>Upload Approved Shops Master Status</th>
						</tr>	
		...
		<div class="form-horizontal span12">
			<div class="form-row control-group row-fluid fluid">
				<div>
					...
					<div style="overflow:auto;"><img src="images/excel_snapshots/approved_shop_master.PNG"/></div>
				</div>
			</div>
		</div>
	</div>
