...
Yii::app()->clientScript->registerScript(
   'validatePlayerForm',
   '$("#service-master-upload-form").submit(function(e){
		var validate=true,
                ...
                <h3>
					...
					<span>Service Master
						...
						<span class="botton_margin1">
							<a href="<?php echo Yii::app()->createUrl("ServiceMaster/admin"); ?>" class="btn btn-success">Services</a>
						</span>        
						</span>
				</h3>
            </div>
	...
	<div class="form-row control-group row-fluid">
		<div class="form-horizontal span6">
			<div class="form-row control-group row-fluid fluid">
				<label>Service Master File</label>
			...
			<div class="form-row control-group row-fluid fluid">
				<?php if(isset($this->importStatus)){?>
					<table style="width:100%;">
						<tr>
							<th>Upload ServiceMaster Status</th>
						</tr>	
		...
		<div class="form-horizontal span12">
			<div class="form-row control-group row-fluid fluid">
				<div>
					...
					<div style="overflow:auto;"><img src="images/excel_snapshots/service.PNG"/></div>
				</div>
			</div>
		</div>
	</div>
