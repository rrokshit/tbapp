 ...
 <div class="title">
            <h3> <i class="icon-book"></i><span>View Contact Detail<span class="botton_mergin3"></span>
			 <span class=botton_margin1><a href="<?php echo Yii::app()->request->baseurl?>/index.php/branchMaster/create"><button class="btn btn-success" rel="tooltip" data-placement="right">Create</button><span class="botton_mergin3"></span><a href="<?php echo Yii::app()->request->baseurl?>/index.php/branchmaster"><button class="btn btn-success" rel="tooltip" data-placement="right">List Branch Master</button></a></span></span></h3>
          </div>
