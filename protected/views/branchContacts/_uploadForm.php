...
Yii::app()->clientScript->registerScript(
   'validatePlayerForm',
   '$("#branch-contacts-upload-form").submit(function(e){
		var validate=true,
    ...
    <div class="box gradient">
        <div>
			<div class="title">
                <h3>
					<i class="icon-book"></i>
					<span>Branch Contacts Master
						<span class="botton_mergin3"></span>
						<span class="botton_margin1">
							<a href="<?php echo Yii::app()->createUrl("BranchContacts/admin"); ?>" class="btn btn-success">Branch Contacts</a>
						</span>        
						</span>
				</h3>
            </div>
		...
		<?php $form=$this->beginWidget('CActiveForm', array(
			'id'=>'branch-contacts-upload-form',
	...
	<div class="form-row control-group row-fluid">
		<div class="form-horizontal span6">
			<div class="form-row control-group row-fluid fluid">
				<label>Branch Contacts Master File</label>
			...
			<div class="form-row control-group row-fluid fluid">
				<?php if(isset($this->importStatus)){?>
					<table style="width:100%;">
						<tr>
							<th>Upload Branch Contact Master Status</th>
						</tr>	
		...
		<div class="form-horizontal span12">
			<div class="form-row control-group row-fluid fluid">
				<div>
					...
					<div style="overflow:auto;"><img src="images/excel_snapshots/branch_contact.PNG"/></div>
				</div>
			</div>
		</div>
	</div>
