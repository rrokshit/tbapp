...
/* @var $data branchmasterMoredetail */
?>
...
<div class="view">
	...
	<br />
	 ...
	 <b><?php echo CHtml::encode($data->getAttributeLabel('branch_id_fk')); ?>:</b>
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('residence_number')); ?>:</b>
	<?php echo CHtml::encode($data->residence_number); ?>
	<br />
