...
Yii::app()->clientScript->registerScript(
   'validatePlayerForm',
   '$("#flight-master-upload-form").submit(function(e){
		var validate=true,
	...
	<div class="form-row control-group row-fluid">
		<div class="form-horizontal span6">
			<div class="form-row control-group row-fluid fluid">
				<label>Flight Master File</label>
			...
			<div class="form-row control-group row-fluid fluid">
				<?php if(isset($this->importStatus)){?>
					<table style="width:100%;">
						<tr>
							<th>Upload FlightMaster Status</th>
						</tr>	
		...
		<div class="form-horizontal span12">
			<div class="form-row control-group row-fluid fluid">
				<div>
					...
					<div style="overflow:auto;"><img src="images/excel_snapshots/flight.PNG"/></div>
				</div>
			</div>
		</div>
	</div>
