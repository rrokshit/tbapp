	...
	<div class="title">
		<h3>
			...
			<span class="botton_margin1">
				<a href="<?php echo Yii::app()->createUrl("FlightMaster/upload"); ?>" class="btn btn-success">Upload</a>
				<a href="<?php echo Yii::app()->createUrl("FlightMaster/create"); ?>" class="btn btn-success">Create</a>
			</span>
		</h3>
	</div>
		...
		array
			...
			'buttons' => array(
					'view' => array(
						...
						'url' => 'Yii::app()->createUrl("FlightMaster/view", array("id"=>$data->id))',
						'options' => array(
							'class' =>'iframe show',
							'rel'=>'gallery',
							'title'=>'View',
