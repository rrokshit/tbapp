<div class="box gradient">
    <div class="title">
        <h4>Sightseeing Vehicle Update  - Display Data From <?php echo date("Y-m-d", strtotime($sdate)); ?> To <?php echo date("Y-m-d", strtotime($edate)); ?><span class="botton_mergin3"></span></h4>
    </div>
...
$this->widget('zii.widgets.grid.CGridView', array
    (
    'dataProvider' => $sightseenDataProvider,
    'summaryText' => '',
    'emptyText' => 'There is no Sightseen Information in your database',
    'columns' => array
        (
        'pnr_no',
        array(
        ...
        array
            ...
            'buttons' => array(
                'av' => array(
                    ...
                    'url' => 'Yii::app()->createUrl("//vehicleUpdate/update", array("id"=>$data->id,"type"=>"sightseen"))',
                    'options' => array(
                        'class' => 'iframe show',
