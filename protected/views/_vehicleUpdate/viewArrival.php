<div class="box gradient">
    <div class="title">
        <h4>Arrival Vehicle Update - Display Data From <?php echo date("Y-m-d", strtotime($sdate)); ?> To <?php echo date("Y-m-d", strtotime($edate)); ?><span class="botton_mergin3"></span></h4>
    </div>
            ...
            array
                ...
                'buttons' => array(
                    'av' => array(
                        ...
                        'url' => 'Yii::app()->createUrl("//vehicleUpdate/update", array("id"=>$data->id,"type"=>"arrival"))',
                        'options' => array(
                            'class' => 'iframe show',
