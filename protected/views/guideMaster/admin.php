 ...
 <div class="box gradient">
	<div class="title">
		<h3>
			...
			<span class="botton_margin1"><a href="<?php echo Yii::app()->createUrl("GuideMaster/create"); ?>" class="btn btn-success">Create</a></span></span>
			<span class="botton_margin1"><a href="<?php echo Yii::app()->createUrl("GuideMaster/upload"); ?>" class="btn btn-success">Upload</a></span></span>
		</h3>
	</div>
<script>
		...
		array
			...
			'buttons' => array(
				'view' => array(
					...
					'url' => 'Yii::app()->createUrl("GuideMaster/view", array("id"=>$data->id))',
					'options' => array(
						'class' =>'iframe show',
		                'rel'=>'gallery',
						'title'=>'View',
