    ...
    <div class="title">
		...
		<span>Train Master
			...
			<span class="botton_margin1">
				<a href="<?php echo Yii::app()->createUrl("TrainMaster/upload"); ?>" class="btn btn-success">Upload</a>  
				<a href="<?php echo Yii::app()->createUrl("TrainMaster/create"); ?>" class="btn btn-success">Create</a>
			</span>
		</span>
        </h3>
    </div>
            ...
            array
                ...
                'buttons' => array(
                    ...
                    'view' => array(
                        ...
                        'url' => 'Yii::app()->createUrl("TrainMaster/view", array("id"=>$data->id))',
							'options' => array(
                            'class' => 'iframe show',
                            'rel' => 'gallery',
                            'title' => 'View',
