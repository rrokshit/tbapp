...
Yii::app()->clientScript->registerScript(
   'validatePlayerForm',
   '$("#vehicle-attachments-upload-form").submit(function(e){
		var validate=true,
    ...
    <div class="box gradient">
        <div>
			<div class="title">
                <h3>
					<i class="icon-book"></i>
					<span>Vehicle Attachments Master
						<span class="botton_mergin3"></span>
						<span class="botton_margin1">
							<a href="<?php echo Yii::app()->createUrl("VehicleAttachments/admin"); ?>" class="btn btn-success">Vehicle Attachments</a>
						</span>        
						</span>
				</h3>
            </div>
		...
		<?php $form=$this->beginWidget('CActiveForm', array(
			'id'=>'vehicle-attachments-upload-form',
	...
	<div class="form-row control-group row-fluid">
		<div class="form-horizontal span6">
			<div class="form-row control-group row-fluid fluid">
				<label>Vehicle Attachments Master File</label>
			...
			<div class="form-row control-group row-fluid fluid">
				<?php if(isset($this->importStatus)){?>
					<table style="width:100%;">
						<tr>
							<th>Upload Vehicle Attachments Master Status</th>
						</tr>	
		...
		<div class="form-horizontal span12">
			<div class="form-row control-group row-fluid fluid">
				<div>
					...
					<div style="overflow:auto;"><img src="images/excel_snapshots/vehicle_attachment.PNG"/></div>
				</div>
			</div>
		</div>
	</div>
