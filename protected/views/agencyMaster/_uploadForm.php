...
Yii::app()->clientScript->registerScript(
   'validatePlayerForm',
   '$("#agency-master-upload-form").submit(function(e){
		var validate=true,
                ...
                <h3>
					...
					<span>Agency Master
						...
						<span class="botton_margin1">
							<a href="<?php echo Yii::app()->createUrl("AgencyMaster/admin"); ?>" class="btn btn-success">Agencys</a>
						</span>        
						</span>
				</h3>
            </div>
	...
	<div class="form-row control-group row-fluid">
		<div class="form-horizontal span6">
			<div class="form-row control-group row-fluid fluid">
				<label>Agency Master File</label>
			...
			<div class="form-row control-group row-fluid fluid">
				<?php if(isset($this->importStatus)){?>
					<table style="width:100%;">
						<tr>
							<th>Upload AgencyMaster Status</th>
						</tr>	
		...
		<div class="form-horizontal span12">
			<div class="form-row control-group row-fluid fluid">
				<div>
					...
					<div style="overflow:auto;"><div style="overflow:auto;"><img src="images/excel_snapshots/agency_master.PNG"/></div></div>
				</div>
			</div>
		</div>
	</div>
