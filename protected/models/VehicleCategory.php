...
class VehicleCategory extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'vehicles' => array(self::HAS_MANY, 'VehicleCategory', 'category_id_fk'),
			'arrivalVehicleCategory' => array(self::HAS_MANY, 'ArrivalVehicle', 'category_id_fk'),
			'departureVehicleCategory' => array(self::HAS_MANY, 'Departurevehicle', 'category_id_fk'),
		);
	}
